...
pub fn cave_hint_dialogue(structures: &[Vec<Structure>], town_x: usize, town_y: usize) -> String {
    let Some((dx, dy, dist)) = find_nearest_structure(structures, town_x, town_y, Structure::Cave) else {
...
pub fn hokora_hint_dialogue(structures: &[Vec<Structure>], town_x: usize, town_y: usize) -> String {
    let Some((dx, dy, dist)) = find_nearest_structure(structures, town_x, town_y, Structure::Hokora) else {
        return townsperson_dialogue().to_string();
    };
...
mod tests {
    ...
    fn cave_hint_dialogue_cave_to_the_north() {
        ...
        let dialogue = cave_hint_dialogue(&structures, 75, 75);
        assert!(
    ...
    fn cave_hint_dialogue_wraparound_finds_closer_cave() {
        ...
        let dialogue = cave_hint_dialogue(&structures, 5, 5);
    ...
    fn hokora_hint_dialogue_to_the_east() {
        ...
        let dialogue = hokora_hint_dialogue(&structures, 75, 75);
        assert!(
    ...
    fn hokora_hint_dialogue_wraparound() {
        ...
        let dialogue = hokora_hint_dialogue(&structures, 5, 5);
        assert!(
            dialogue.contains("すぐ ちかくの"),
